...
import 'package:messio/pages/AttachmentsPage.dart';
                                      ...
                                      builder: (context, state) {
                                        return Column(
                                          ...
                                          children: <Widget>[
                                            ...
                                            Text(_username, style: Styles.text)
                                          ],
                                        );
                                      },
                                    ),
                              ...
                              children: <Widget>[
                                  ...
                                  onTap: () => Navigator.push(
                                    ...
                                    SlideLeftRoute(
                                      page: AttachmentsPage(
                                          this.chat.chatId, FileType.image),
                                    ),
                                  ),
                                  child: Text(
                                    'Photos',
                                ...
                                GestureDetector(
                                  onTap: () => Navigator.push(
                                    ...
                                    SlideLeftRoute(
                                      page: AttachmentsPage(
                                          this.chat.chatId, FileType.video),
                                    ),
                                  ),
                                  child: Text(
                                    'Videos',
                                ...
                                GestureDetector(
                                  onTap: () => Navigator.push(
                                    ...
                                    SlideLeftRoute(
                                      page: AttachmentsPage(
                                          this.chat.chatId, FileType.any),
                                    ),
                                  ),
                                  child: Text('Files', style: Styles.text),
                                )
                              ],
                            ),
                          ),
