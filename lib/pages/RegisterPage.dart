...
import 'package:messio/widgets/CircularIndicator.dart';
...
class _RegisterPageState extends State<RegisterPage>
  ...
  void initApp() {
    ...
    profilePicHeightAnimation =
        Tween(begin: 100.0, end: 10.0).animate(usernameFieldAnimationController)
          ..addListener(() {
            setState(() {});
          });
    usernameAnimation =
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                for (int i = 0; i < 2; i++) CircularIndicator(i == currentPage),
              ],
            ),
          ),
